...
(function($) {
	...
	*/
	...
	function centery(){		
		jQuery('.center-y').each(function() {
			var $doc_height = jQuery(window).innerHeight();
			var picheight = jQuery(this).css("height");
			picheight = parseInt(picheight, 10);
			jQuery(this).css('margin-top', (($doc_height - picheight) / 2) - 90);
		});
	}
	/* --------------------------------------------------
	 * document ready
	...
	jQuery(document).ready(function() {
		...
		jQuery('.arrowup').each(function(){
			var bgcolor = jQuery(this).next().attr('data-bgcolor');
